          ...
          <div className="row" data-aos="fade-up" data-aos-delay="100">
            <div className="col-lg-3">
              <Nav variant="pills" className="flex-column">
                <Nav.Item>
                  <Nav.Link eventKey="tab-1">Linguini al Nero di Sepia</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="tab-2">Filetto a la Rossini</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="tab-3">Sol di Sorrento</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="tab-4">Spaguetti al Vongole</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="tab-5">Risoto di mare</Nav.Link>
                </Nav.Item>
              </Nav>
            </div>
